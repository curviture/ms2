...
<head>
    ...
    <body>
                ...
                <div class="header__inner container">
                    ...
                    <div class="header__menu-wrapper">
                        <ul class="menu menu--header">
                            ...
                            <li class="menu__item hidden--md visible--lg"><a class="menu__link animated-underline" href="/divany.html">Диваны</a></li>
                            <li class="menu__item"><a class="menu__link animated-underline js-scrollto" href="#looking-for">На заказ</a></li>
                    ...
                    <div class="header__contacts">
                        ...
                        <input id="call-from-navbar" class="button button--tiny button--secondary" type="button" value="Заказать звонок" data-toggle="modal" data-target="#js-call-navbar">
                    </div>
                </div>
            </div>
            <div class="hero">
            ...
            <div class="gallery text-dark u-pt u-pb">
                <div class="gallery__header u-jc--space-between">
                    ...
                    <ul class="gallery__type">
                        ...
                        <li><a class="button button--transparent gallery__type-button"  href="/divany.html">Диваны</a></li>
                    </ul>
                </div>
                <div id="gallery" >
                    <ul class="gallery__list u-jc--space-between">
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-content">
                                <div class="gallery__item-info">
                                    ...
                                    <span class="gallery__item-price">58.000 рублей</span>
                                </div>
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-20" data-orderName="Балу" data-price="58.000 рублей" data-type="Кровать" data-img="img/1-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Балу" data-price="58.000 рублей" data-type="Кровать">
                            </div>
                        </li>                        
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent button--bordered js-more-trigger" data-image="#modal-0" data-orderName="Global" data-price="47.000 рублей" data-type="Кровать" data-img="img/2-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Global" data-price="47.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent  js-more-trigger button--bordered" data-orderName="Milky Way" data-price="50.000 рублей" data-type="Кровать" data-img="img/4-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Milky Way" data-price="50.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-4" data-orderName="Kim" data-price="60.000 рублей" data-type="Кровать" data-img="img/6-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Kim" data-price="60.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-5" data-type="Кровать" data-orderName="Маквин" data-price="45.000 рублей" data-img="img/9-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Кровать" data-price="Маквин" data-type="45.000 рублей">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-7" data-orderName="Black Wave" data-price="45.000 рублей" data-type="Кровать" data-img="img/7-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Black Wave" data-price="45.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-content">
                                <div class="gallery__item-info">
                                    ...
                                    <span class="gallery__item-price">35.000 рублей</span>
                                </div>
                                <div class="gallery__item-thumbs">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-8" data-orderName="Грейленд" data-price="35.000 рублей" data-type="Кровать" data-img="img/10-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Грейленд" data-price="35.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-content">
                                <div class="gallery__item-info">
                                    ...
                                    <span class="gallery__item-price">32.000 рублей</span>
                                </div>
                                <div class="gallery__item-thumbs">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-10" data-orderName="Elena" data-price="32.000 рублей" data-type="Кровать" data-img="img/13-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Elena" data-price="32.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-content">
                                <div class="gallery__item-info">
                                    ...
                                    <span class="gallery__item-price">40.000 рублей</span>
                                </div>
                                <div class="gallery__item-thumbs">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-11" data-orderName="Брианза" data-price="40.000 рублей" data-type="Кровать" data-img="img/16-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Брианза" data-price="40.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-12" data-orderName="Феерия" data-price="45.000 рублей" data-type="Кровать" data-img="img/20-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Феерия" data-price="45.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-13" data-price="35.000 рублей" data-type="Кровать" data-orderName="София" data-img="img/19-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-price="35.000 рублей" data-type="Кровать" data-name="София">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-content">
                                <div class="gallery__item-info">
                                    ...
                                    <span class="gallery__item-price">33.000 рублей</span>
                                </div>
                                <div class="gallery__item-thumbs">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-14" data-orderName="Диана" data-price="33.000 рублей" data-type="Детская кровать" data-img="img/21-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Диана" data-price="33.000 рублей" data-type="Детская кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-15" data-orderName="Салото" data-price="35.000 рублей" data-type="Кровать" data-img="img/18-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Салото" data-price="35.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-16" data-orderName="Миа" data-price="40.000 рублей" data-type="Кровать" data-img="img/17-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Миа" data-price="40.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-content">
                                <div class="gallery__item-info">
                                    ...
                                    <span class="gallery__item-price">39.000 рублей</span>
                                </div>
                                <div class="gallery__item-thumbs">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-17" data-orderName="Moment" data-price="39.000 рублей" data-type="Кровать" data-img="img/14-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Moment" data-price="39.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-18" data-orderName="Аква" data-price="40.000 рублей" data-type="Кровать" data-img="img/14-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Аква" data-price="40.000 рублей" data-type="Кровать">
                            </div>
                        </li>
                        ...
                        <li class="gallery__item">
                            ...
                            <div class="gallery__item-content">
                                <div class="gallery__item-info">
                                    ...
                                    <span class="gallery__item-price">44.000 рублей</span>
                                </div>
                                <div class="gallery__item-thumbs">
                            ...
                            <div class="gallery__item-ordering">
                                <input type="button" value="Подробнее" class="button button--transparent js-more-trigger button--bordered" data-target="#modal-19" data-orderName="Маэстро" data-price="44.000 рублей" data-type="Кровать" data-img="img/12-(1).jpg">
                                <input type="button" value="Заказать" class="button button--attention js-order" data-orderName="Маэстро" data-price="44.000 рублей" data-type="Кровать">
                            </div>
                        </li>
        ...
        <div data-jarallax data-speed="0.5" class="jarallax std-blck std-blck--bg contact-us js-parallax" data-parallax="scroll" data-image-src="./img/bg10.jpg">
            <div class="container contact-us__inner u-jc--space-around">
                ...
                <div class="form__container">
                    <form action="" class="form form--small js-form">
                        <input type="hidden" name="fromWhere" value="contact-us divany">
                        ...
                        <div class="input__group">
                            <input type="checkbox" name="check" id="check" class="contact-us__checkbox form__agreement" value="hello" placeholder="hello" required checked>
            ...
            <div class="header__inner container">
                ...
                <div class="menu__box" id="js-menu__totrigger">
                    ...
                    <ul class="menu menu--header">
                        ...
                        <li class="menu__item "><a class="menu__link animated-underline" href="/divany.html">Диваны</a></li>
                        <li class="menu__item js-f-menuitem u-hidden--tl"><a class="menu__link animated-underline u-hidden--tl" href="#">На заказ</a></li>
        ...
        <div class="form__container" id="js-navbar-order-modal">
            <form name="form-navbar" method="post" class="form js-form" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" id="form-navbar">
                <h2 class="modal__title heading heading--tertiary form__heading">Оставьте заявку <br> <span>чтобы мы перезвонили вам</span></h2>
                <input type="hidden" name="fromWhere" value="Navbar button click divany">
                <div class="input__group">
                    <input class="input" type="text" name="userName" placeholder="Введите свое имя" required>
                </div>
                <div class="input__group">
                    <input class="input js-phone__input" type="text" placeholder="Введите свой телефон"  required pattern="\+7\([0-9]{3}\)[0-9]{3}-[0-9]{2}-[0-9]{2}" required>
                </div>
                <div class="input__group">
                    <input class="button button--attention button--block" type="submit" value="Перезвоните мне">
                </div> 
                <div class="input__group">
                    <input type="checkbox" name="navbar-order-modal-check" id="navbar-order-modal-check" class="form__agreement" required checked>
        ...
        <div class="form__container" tabindex="-1" id="js-call-looking-for-modal">
            <form class="form form--small" action="">
                <h2 class="tingle-modal__title heading heading--tertiary form__heading">Оставьте заявку <br> <span>для рассчета стоимости вашего дивана</span></h2>
                    <input type="hidden" name="fromWhere" id="hidden__call-looking-for-modal" value="looking-for divany">
                    <div class="input__group">
                        <input class="input" type="text" name="userName" placeholder="Введите свое имя" required>
                    </div>
                    <div class="input__group">
                    ...
                    <div class="input__group">
                        <input type="checkbox" name="call-looking-for-modal" id="call-looking-for-modal" class="form__agreement" checked>
        ...
        <div class="form__container" id="js-order-gallery-modal">
            <form action="" class="form">
                ...
                <input type="hidden" value="Order from gallery divan" id="order__hidden" name="fromWhere">
                ...
                <div class="input__group">
                    <input type="checkbox" name="order-modal-check" id="order-modal-check" class="form__agreement" required checked>
        ...
        <div class="thank-you" id="thank-you" style="display: none;">
            <div class="thank-you__inner">
                ...
                Хотите посмотреть наши другие продукции
                <button> Арнико Диваны</button> 
            </div>
