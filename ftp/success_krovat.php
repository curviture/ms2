...
<meta http-equiv="refresh" content="10; URL=./divanyphp">
...
.btn-primary { background-color: #f10; color:#fff; text-decoration:none; border-color: #0a568a; position:relative;   padding-top: 13px; padding-bottom: 13px; padding-right: 25px;}
...
<script>ym(85292497,'reachGoal','lead');</script>
<div id="container">
</div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="thank-you-page-content">
            <h1>Спасибо за заявку<br> 
              мы свяжемся с Вами в ближайшее время</h1>
            <a href="/index.php" class="btn btn-primary arrow-icon"> Вернутся назад </a>
          </div>
          <div class="thank-you-copy">
            <p>made by: Gevorg Ghazaryan/2022 &copy;</p>
          </div>
        </div>
